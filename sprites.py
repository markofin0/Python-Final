...
class Enemy2(pygame.sprite.Sprite):
    def __init__(self, game, x, y):
        ...
        self.image = self.game.enemy2_spritesheet.get_sprite(15, 35, self.width, self.height)
    ...
    def animate(self):
        ...
        left_animations = [self.game.enemy2_spritesheet.get_sprite(145, 62, self.width, self.height),
                           self.game.enemy2_spritesheet.get_sprite(80, 64, self.width, self.height),
                           self.game.enemy2_spritesheet.get_sprite(16, 66, self.width, self.height)]

        right_animations = [self.game.enemy2_spritesheet.get_sprite(80, 34, self.width, self.height),
                            self.game.enemy2_spritesheet.get_sprite(144, 36, self.width, self.height),
                            self.game.enemy2_spritesheet.get_sprite(208, 36, self.width, self.height)]

        if self.facing == "left":
            if self.x_change == 0:
                self.image = self.game.enemy2_spritesheet.get_sprite(208, 64, self.width, self.height)
            else:
                self.image = left_animations[math.floor(self.animation_loop)]
                self.animation_loop += 0.1
                if self.animation_loop >= 3:
